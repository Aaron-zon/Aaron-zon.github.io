import{ax as a,A as n,aQ as p,z as e}from"./chunks/framework.BWRXlwpK.js";const h=JSON.parse('{"title":"整体架构","description":"","frontmatter":{},"headers":[],"relativePath":"rabbitMQ/rabbitmq-architecture.md","filePath":"rabbitMQ/rabbitmq-architecture.md"}'),l={name:"rabbitMQ/rabbitmq-architecture.md"};function i(c,s,t,o,r,u){return e(),n("div",null,s[0]||(s[0]=[p(`<h1 id="整体架构" tabindex="-1">整体架构 <a class="header-anchor" href="#整体架构" aria-label="Permalink to &quot;整体架构&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>                RabbitMQ Broker</span></span>
