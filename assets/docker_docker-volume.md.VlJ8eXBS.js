import{ax as n,A as s,aQ as e,z as p}from"./chunks/framework.BWRXlwpK.js";const h=JSON.parse('{"title":"Volume（数据卷）","description":"","frontmatter":{},"headers":[],"relativePath":"docker/docker-volume.md","filePath":"docker/docker-volume.md","lastUpdated":1788400509000}'),l={name:"docker/docker-volume.md"};function o(t,a,i,c,d,r){return p(),s("div",null,a[0]||(a[0]=[e(`<h1 id="volume-数据卷" tabindex="-1">Volume（数据卷） <a class="header-anchor" href="#volume-数据卷" aria-label="Permalink to &quot;Volume（数据卷）&quot;">​</a></h1><blockquote><p>Volume 处理的是数据如何持久化的问题。</p></blockquote><p>因为容器中的数据在容器中，一旦容器被删除，数据也会随之消失，所以我们需要将数据持久化。</p><p>在Container中，数据一直存在 <code>Writable Layer（可写层）</code></p><p>例如：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>MySQL Container</span></span>
