import{ax as a,A as n,aQ as p,z as i}from"./chunks/framework.BWRXlwpK.js";const r=JSON.parse('{"title":"缓存击穿","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"redis/cache-break.md","filePath":"redis/cache-break.md","lastUpdated":1788144986000}'),e={name:"redis/cache-break.md"};function l(t,s,h,d,c,k){return i(),n("div",null,s[0]||(s[0]=[p(`<h1 id="缓存击穿" tabindex="-1">缓存击穿 <a class="header-anchor" href="#缓存击穿" aria-label="Permalink to &quot;缓存击穿&quot;">​</a></h1><p>某一个热点数据失效的一瞬间，大量请求同时访问数据库。</p><h2 id="什么是热点数据" tabindex="-1">什么是热点数据？ <a class="header-anchor" href="#什么是热点数据" aria-label="Permalink to &quot;什么是热点数据？&quot;">​</a></h2><p>例如：</p><p>商品 <code>1001</code> 是一个秒杀商品，每天要承受100万次访问。</p><p>Redis <code>goods:1001</code> 缓存 <code>30分钟</code></p><p>正常情况</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>用户</span></span>
