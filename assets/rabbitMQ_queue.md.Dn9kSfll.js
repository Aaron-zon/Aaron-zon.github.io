...
<span class="line"><span>   └────► Queue_C ───► Consumer_C</span></span></code></pre></div><p>不是多个 Consumer 监听同一个 Queue，而是多个 Queue 分别接收同一条消息。</p>`,49)]))}const g=a(l,[["render",i]]);export{r as __pageData,g as default};
