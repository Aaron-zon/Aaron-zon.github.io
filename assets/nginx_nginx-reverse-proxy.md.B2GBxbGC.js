import{ax as a,A as n,aQ as i,z as p}from"./chunks/framework.BWRXlwpK.js";const g=JSON.parse('{"title":"Nginx 反向代理","description":"","frontmatter":{},"headers":[],"relativePath":"nginx/nginx-reverse-proxy.md","filePath":"nginx/nginx-reverse-proxy.md","lastUpdated":1788775153000}'),l={name:"nginx/nginx-reverse-proxy.md"};function t(e,s,o,c,r,h){return p(),n("div",null,s[0]||(s[0]=[i(`<h1 id="nginx-反向代理" tabindex="-1">Nginx 反向代理 <a class="header-anchor" href="#nginx-反向代理" aria-label="Permalink to &quot;Nginx 反向代理&quot;">​</a></h1><p>前提：系统中已经安装好 jdk 和 tomcat，并配置好环境变量。</p><p>假设以下为安装地址：</p><ul><li>jdk路径：/usr/local/java/</li><li>tomcat路径：/usr/local/tomcat/ <ul><li>启动方式：/usr/local/tomcat/bin -&gt; ./startup.sh</li><li>停止方式：/usr/local/tomcat/bin -&gt; ./shutdown.sh</li></ul></li></ul><p>原场景：访问 aaron4899.com 显示 /usr/local/nginx/aaron/index.html 现需求：访问 aaron4899.com 显示 tomcat 页面</p><p>步骤：</p><ol><li>打开 nginx 配置文件</li></ol><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">cd</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /usr/local/nginx/conf</span></span>
