import{ax as a,A as i,aQ as n,z as l}from"./chunks/framework.BWRXlwpK.js";const o=JSON.parse('{"title":"开机或登录自动启动","description":"","frontmatter":{},"headers":[],"relativePath":"linux/linux-boot.md","filePath":"linux/linux-boot.md","lastUpdated":1788775153000}'),p={name:"linux/linux-boot.md"};function e(t,s,h,k,d,c){return l(),i("div",null,s[0]||(s[0]=[n(`<h1 id="开机或登录自动启动" tabindex="-1">开机或登录自动启动 <a class="header-anchor" href="#开机或登录自动启动" aria-label="Permalink to &quot;开机或登录自动启动&quot;">​</a></h1><p>方法1：</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">cd</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ~</span></span>
